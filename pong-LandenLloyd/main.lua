...
PADDLE_SPEED = 200
-- The AI gets a slower speed because their reaction time is 0
AI_PADDLE_SPEED = PADDLE_SPEED/2
...
function love.update(dt)
    ...
    -- AI for player 2
    -- Moves the paddle towards the center of the screen while the ball is moving away,
    -- Tracks the ball otherwise
    if ball.dx < 0 then
        player2:goToTarget(VIRTUAL_HEIGHT/2)
    elseif ball.dx > 0 then
        player2:goToTarget(ball.y)
    end
